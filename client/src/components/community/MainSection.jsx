    ...
    <div className="flex flex-col">
      <ul className="flex">
        <li
          className={`${
            activeTab === "All posts"
              ? "border-blue-500 bg-dark-text rounded-md text-white"
      ...
      <div className="mt-4 flex flex-col gap-4">
        {activeTab === "All posts" && (
          <>
            ...
            {communityPosts.length < totalCommunityPosts && (
              <button
                className="bg-dark-text hover:bg-blue-700 text-sm text-white font-semibold rounded-md w-full p-2 my-3"
