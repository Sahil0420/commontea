  ...
  return (
    <div className="bg-white rounded-md ">
      <div className="flex flex-col ">
        ...
        <div className="flex items-center gap-2 text-dark-text mb-4">
          <HiUserGroup />
          <span className="mr-2">
            {members?.length || 0}{" "}
      ...
      <div className="my-4">
        {isModeratorOfThisCommunity && (
          <Link
            ...
            className="px-4 bg-dark-texttext-dark-text text-white shadow-md shadow-gray-50 text-sm py-1 rounded-md flex justify-center items-center w-full my-2 hover:bg-dark-texttext-dark-text-600"
          >
            Moderation Panel
          </Link>
        )}
